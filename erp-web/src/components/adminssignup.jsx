...
import Admin from '../assets/adpic.png';
...
const AdminsSignup = () => {
    ...
    // Add this line to define the isLoading state
    ...
    const handleRegisterClick = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8080/signup/admin', {
                method: 'POST',
                headers: { 
        ...
        <div
            ...
            <div>
                ...
                <div className="pt-16 pb-[50px] mx-48 mb-[250px] mt-16 bg-purple-200 flex flex-col items-center rounded-lg shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
                    <img className="h-64 w-[300px] mb-4" src={Admin} alt="Admin's Signup" />
